			...
			<div className="SkillRow" style={style}>
				...
				<div className="skill">
					...
					<p>
						...
						in the browser. I like the challenges that I face during development
						,the challenges act as a Speed-Booster to my skills .
					</p>{" "}
					<br />
					<br />
					<h3>Skills</h3>
				...
				<div className="skill">
					...
					<p>
						{" "}
						I love writing Back-end Code as it helps in bringing ideas to
						reality come true.
					</p>
					<br />
					<br />
				...
				<div className="skill">
					...
					<p>
						{" "}
						I Believe that In order to be irreplaceable, one must always be
						different. Generally, the craft of programming is the factoring of a
						set of requirements into a a set of functions and data structures.
					</p>
					<br />
					<br />
					<br />
